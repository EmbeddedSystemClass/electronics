...
uint8_t     I_can_check_sensors = 1;
uint8_t     g_mon_sleep = 0;
...
void        check_sensors()
{
                        check_level();  //ca put du cul il ecrit nimp sur lecran grr
                        check_moisture();
			check_temp();
                        get_light_manual();
...
//                          nb_check = 0;
//                        }
//                        tab_save[0][nb_check] = humidity;
//                        tab_save[1][nb_check] = Temperature; // stockage double sur int
//                        tab_save[2][nb_check] = lum_p;
////                      tab_save[3][nb_check] =
//                        nb_check++;
//                        I_can_check_sensors = 0;
//                        int_rtcc = 0;
