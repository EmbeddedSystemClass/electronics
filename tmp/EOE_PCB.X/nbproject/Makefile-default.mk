...
SOURCEFILES_QUOTED_IF_SPACED=adc_auto.c adc_manoual.c bargraph.c delay_micro.c display.c gpio.c gpio_exp.c I2C.c interrupt.c lcd.c led.c level.c light.c main.c moisture.c rtcc.c save.c sleep.c temperature.c watchdog.c IIC_soft.c gpio_exp_soft.c system.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/adc_auto.o ${OBJECTDIR}/adc_manoual.o ${OBJECTDIR}/bargraph.o ${OBJECTDIR}/delay_micro.o ${OBJECTDIR}/display.o ${OBJECTDIR}/gpio.o ${OBJECTDIR}/gpio_exp.o ${OBJECTDIR}/I2C.o ${OBJECTDIR}/interrupt.o ${OBJECTDIR}/lcd.o ${OBJECTDIR}/led.o ${OBJECTDIR}/level.o ${OBJECTDIR}/light.o ${OBJECTDIR}/main.o ${OBJECTDIR}/moisture.o ${OBJECTDIR}/rtcc.o ${OBJECTDIR}/save.o ${OBJECTDIR}/sleep.o ${OBJECTDIR}/temperature.o ${OBJECTDIR}/watchdog.o ${OBJECTDIR}/IIC_soft.o ${OBJECTDIR}/gpio_exp_soft.o ${OBJECTDIR}/system.o
...
# Source Files
SOURCEFILES=adc_auto.c adc_manoual.c bargraph.c delay_micro.c display.c gpio.c gpio_exp.c I2C.c interrupt.c lcd.c led.c level.c light.c main.c moisture.c rtcc.c save.c sleep.c temperature.c watchdog.c IIC_soft.c gpio_exp_soft.c system.c
...
${OBJECTDIR}/IIC_soft.o: IIC_soft.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/IIC_soft.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_ICD3=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/IIC_soft.o.d" -o ${OBJECTDIR}/IIC_soft.o IIC_soft.c    -DXPRJ_default=$(CND_CONF)  -no-legacy-libc  $(COMPARISON_BUILD) 
